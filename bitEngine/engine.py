...
class Bit:
    ...
    def create_window(self, height: int = 740, width: int = 1200, title: str = "The Bit Engine", icon: str = "favicon.png", background_color: str | Tuple[int] = "#1A1A1A", scanline_alpha: int = 70, bend_amount: float = 0.85, flicker_intensity: int = 20, crt_effect: bool = False) -> Dict[str, object]:
        ...
        return {
            "window": self.window,
            "window_page_manager": self.window.page_manager
        }
